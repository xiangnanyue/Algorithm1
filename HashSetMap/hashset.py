...
class HashSet:
    # this Placeholder serves as the private class
    class __Placeholder:
        def __init__(self):
            pass
    ...
    def __add(item,items):
        ...
        while items[idx] != None:
            ...
            # we do not allow none in the hash set, this is why we use placeholder
            # and we will first use the placeholder in memory
